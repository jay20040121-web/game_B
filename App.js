import BattleAdventureOverlay from './src/components/BattleAdventureOverlay';
import DiaryOverlay from './src/components/DiaryOverlay';
                    ...
                    <div className="logical-canvas flex flex-col items-center justify-between pointer-events-none">
                        ...
                        {isBooting ? (
                            ...
                            <>
                                ...
                                <div className="w-[240px] h-[32px] border-2 border-[#1a1a1a] flex items-center px-2 overflow-hidden z-20 bg-[#9dae8a] shrink-0 mb-[5px] shadow-[inset_2px_2px_0_rgba(0,0,0,0.2)]">
