...
export const MONSTER_ASSET_IDS = {
    "116": "117", // 海刺龍 (ID 116) 使用原海刺龍圖片 (117)
    "117": "230", // 刺龍王 (ID 117) 使用刺龍王圖片 (230)
    "58": "229",  // 黑魯加 (ID 58) 使用黑魯加圖片 (229)
    "77": "156",  // 火岩鼠 (ID 77) 使用火岩鼠圖片 (156)
    "78": "157",  // 火爆獸 (ID 78) 使用火爆獸圖片 (157)
    "46": "153", // 月桂葉 (ID 46) 使用月桂葉圖片 (153)
    "47": "154",  // 大竺葵 (ID 47) 使用大竺葵圖片 (154)
    "43": "252",  // 木守宮 (ID 43) 使用木守宮圖片 (252)
    "69": "281",  // 奇魯莉安 (ID 69) 使用奇魯莉安圖片 (281)
    "44": "253",  // 森林蜥蜴 (ID 44) 使用森林蜥蜴圖片 (253)
    "45": "254",  // 蜥蜴王 (ID 45) 使用蜥蜴王圖片 (254)
    "71": "282"   // 沙奈朵 (ID 71) 使用沙奈朵圖片 (282)
};
...
export const OBTAINABLE_MONSTER_IDS = [
    ...
    1, 2, 3,       // 妙蛙種子線
    43, 44, 45,    // 走路草線
    69, 71,        // 喇叭芽線 (69 Bellsprout, 71 Victreebel)
    46, 47,        // 月桂葉線
    102, 103,      // 蛋蛋線
    ...
    // --- 7. 特殊培育與野外捕捉 (P, F, G Series & Wild) ---
    109, 110,      // 瓦斯彈線 (P)
    88, 89,        // 臭泥線 (P)
    82,            // 三合一磁怪 (P Special)
    66, 67, 68,    // 腕力線 (F)
    106, 107,      // 沙瓦郎/艾比郎 (F Failed)
    54, 55,        // 可達鴨線 (P Special)
    92, 93, 94,    // 鬼斯線 (G1)
    63, 64, 65,    // 凱西線 (G2)
    16, 17, 18,    // 波波線 (Wild)
    23, 24,        // 阿柏蛇線 (Wild)
