...
export const OBTAINABLE_MONSTER_IDS = [
    ...
    // --- 2. 一般線 (A, C, FAIL 分支) ---
    1013, 1014, 1041, 1015,    // 德魯線 (A)
    1016, 1017, 1040,  // 伊麗莎線 (C)
    1018,           // 女皇莎白 (FAIL)

    // --- 3. 靈魂進化 - 火系 (Fire Soul) ---
    1001, 1002, 1003, 1030, 1031,       // 火星獸線 & 喵星人線

    // --- 4. 靈魂進化 - 水系 (Water Soul) ---
    1004, 1005, 1042, 1006, 1028, 1029,       // 泡泡獸線 & 守護龍線

    // --- 5. 靈魂進化 - 草系 (Grass Soul) ---
    1007, 1008, 1009, 1032, 1033, 1034,       // 棉棉獸線 & 熱血芽獸線

    // --- 6. 靈魂進化 - 蟲系 (Bug Soul) ---
    1010, 1011, 1012, 1035, 1036, 1037,    // 蜂兵線 & 小角幼甲線
