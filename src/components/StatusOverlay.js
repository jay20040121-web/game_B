            ...
            <div className="flex-1 w-full flex flex-col gap-1.5 px-1 justify-start pb-1 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-x-2 gap-y-0.5 px-1.5 py-1 mt-0.5">
                    {(() => {
                        ...
                        return (
                            <>
                                <div className="text-[10px] font-black text-white">血量: {fHP} <span className="opacity-50 text-[8px]">({getIVGrade(advStats.ivs.hp)})</span></div>
                                ...
                                <div className="text-[10px] font-black text-white">戰力: {advStats.basePower}</div>
                            </>
                        );
                    })()}
                </div>
