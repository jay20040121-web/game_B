...
export const MONSTER_REGISTRY = [
    ...
    { id: 1003, oldId: 6, name: "火星摔角人", types: ["fire"], baseStats: { hp: 78, atk: 109, def: 85, spd: 100 }, assetId: "6" },
    ...
    // === 草系靈魂 ===
    { id: 1007, oldId: 1, name: "綿綿獸", types: ["grass"], baseStats: { hp: 45, atk: 65, def: 65, spd: 45 }, assetId: null },
    { id: 1008, oldId: 2, name: "甜點獸", types: ["grass"], baseStats: { hp: 60, atk: 80, def: 80, spd: 60 }, assetId: null },
    { id: 1009, oldId: 3, name: "草莓蛋糕獸", types: ["grass"], baseStats: { hp: 80, atk: 100, def: 100, spd: 80 }, assetId: null },
    ...
    { id: 1012, oldId: 12, name: "女王蜂", types: ["bug"], baseStats: { hp: 80, atk: 90, def: 110, spd: 90 }, assetId: "12" },
    ...
    { id: 1015, oldId: 34, name: "王者咪兔", types: ["poison"], baseStats: { hp: 91, atk: 92, def: 90, spd: 65 }, assetId: "34" },
    ...
    // === 死亡重生 G1 ===
    { id: 1019, oldId: 92, name: "鬼斯", types: ["ghost"], baseStats: { hp: 30, atk: 100, def: 35, spd: 80 }, assetId: null },
    { id: 1020, oldId: 93, name: "鬼斯通", types: ["ghost"], baseStats: { hp: 45, atk: 115, def: 55, spd: 95 }, assetId: null },
    { id: 1021, oldId: 94, name: "耿鬼", types: ["ghost"], baseStats: { hp: 60, atk: 130, def: 75, spd: 110 }, assetId: null },

    // === 野外 (波波線) ===
    { id: 1022, oldId: 16, name: "小雞獸", types: ["flying"], baseStats: { hp: 40, atk: 45, def: 40, spd: 56 }, assetId: "16" },
    { id: 1023, oldId: 17, name: "捲尾麻雀", types: ["flying"], baseStats: { hp: 63, atk: 70, def: 55, spd: 71 }, assetId: "17" },
    { id: 1024, oldId: 18, name: "US老鷹獸", types: ["flying"], baseStats: { hp: 83, atk: 90, def: 75, spd: 101 }, assetId: "18" },

    // === 野外 (小拳石線) ===
    { id: 1025, oldId: 74, name: "石精靈", types: ["rock"], baseStats: { hp: 40, atk: 80, def: 100, spd: 20 }, assetId: "74" },
    { id: 1026, oldId: 75, name: "岩石巨兵", types: ["rock"], baseStats: { hp: 55, atk: 95, def: 115, spd: 35 }, assetId: "75" },
    { id: 1027, oldId: 76, name: "石像魔", types: ["rock"], baseStats: { hp: 80, atk: 120, def: 130, spd: 45 }, assetId: "76" },
];
