...
const ADV_ITEMS = [
    ...
    { id: '019', name: "技能轉換器", desc: "可隨意調整 4 招技能的順序。限滿 4 招時使用。", rarity: 3 },
    { id: '020', name: "個體值提升劑", desc: "隨機提升一項個體值評級 (例如 A -> S)。", rarity: 5 },
    { id: '021', name: "回憶膠囊", desc: "儲存了過往同伴的回憶，使用後可讓該怪獸重生。", rarity: 5 }
];
