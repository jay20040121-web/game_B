...
- 一般野怪等級是玩家等級的 70% 到 90%，最高 100 等，且不會高於玩家目前同行怪獸等級；冒險模式不再生成精銳野怪。
...
- 聯盟 NPC 強度依輪次，不再單純依玩家等級：第 1 輪玩家 -5 等、第 2 輪玩家 -3 等、第 3、4 輪同等級、第 5 輪玩家 +5 等且封頂 100 等。聯盟第 5 輪勝利後可選擇一次技能附魔；附魔永久保留並可無限累積，單次傷害 +1%、命中 +2% 或先手率 +0.1。
- 聯盟 NPC stage 規則：第 1 到第 3 輪不能高於玩家 stage；第 4、5 輪不能低於玩家 stage。
- 聯盟大會已移除肉鴿卡片與中途獎勵；第 5 輪勝利先進入冠軍附魔選擇，完成後再進入決賽／額外冠軍挑戰流程。
